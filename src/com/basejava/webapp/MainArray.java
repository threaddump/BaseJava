        ...
        while (true) {
            ...
            switch (params[0]) {
                ...
                case "size":
                    ...
                    break;
                case "save":
                    r = new Resume(params[1].intern());
                    ARRAY_STORAGE.save(r);
                    printAll();
                    break;
                case "update":
                    r = new Resume(params[2].intern(), params[1].intern());
                    ARRAY_STORAGE.update(r);
                    printAll();
                    break;
                case "delete":
                    ARRAY_STORAGE.delete(params[1].intern());
                    printAll();
                    break;
                case "get":
                    System.out.println(ARRAY_STORAGE.get(params[1].intern()));
                    break;
                case "clear":
                    ARRAY_STORAGE.clear();
                    printAll();
